...
<div class="panel-body">
  ...
  <div class="row">
  	...
  	<div class="col-lg-3">
		  ...
		  <div class="panel-body">
		    <h2><a href="<?= site_url('admin/user') ?>"><?= $user; ?> Users</a></h2>
		  </div>
		</div>
  	</div>
  	...
  	<div class="col-lg-3">
		  ...
		  <div class="panel-body">
		    <h2><a href="<?= site_url('admin/project'); ?>"><?= $project; ?> Projects</a></h2>
		  </div>
		</div>
  	</div>
  	...
  	<div class="col-lg-3">
		  ...
		  <div class="panel-body">
		    <h2><a href="<?= site_url('admin/project'); ?>"><?= $channel; ?> Channels</a></h2>
		  </div>
		</div>
  	</div>
